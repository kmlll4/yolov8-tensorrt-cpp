...
set(_TensorRT_SEARCH_NORMAL PATHS "/usr")
...
if(TensorRT_FOUND)
    ...
    if(NOT TensorRT_LIBRARIES)
        set(TensorRT_LIBRARIES ${TensorRT_LIBRARY} ${TensorRT_NVONNXPARSER_LIBRARY} ${TensorRT_NVPARSERS_LIBRARY} ${TensorRT_PLUGIN_LIBRARY})
    endif()
